(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git intellij-theme tangotango-theme sudo-edit ssh company-quickhelp company-flx multiple-cursors org-bullets timu-caribbean-theme company-box company-posframe auctex treemacs ztree marginalia consult use-package vertico company))))
(custom-set-faces
...
(use-package treemacs
  ...
  (message "ESTOY EN EL TREEMACS CONFIGURANDO")
