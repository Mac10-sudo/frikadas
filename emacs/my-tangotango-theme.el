...
(custom-theme-set-faces
 ...
 '(centaur-tabs-default ((t (:height 0.8 :foreground "black" :background "black"))))
 '(tab-line ((t (:inherit variable-pitch :background "gray20" :foreground "black" :height 0.9))))
 ...
 '(centaur-tabs-unselected ((t (:background "#3D3C3D" :foreground "gray70" :overline nil :underline nil :height 0.8)))))

(provide-theme 'my-tangotango)
